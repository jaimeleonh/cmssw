...
TauRefProducer = cms.EDProducer("HLTTauRefProducer",
                    ...
                    Jets = cms.untracked.PSet(
                            ...
                            # JetCollection = cms.untracked.InputTag("ak4PFJets"),
...
hltTauOfflineMonitor_PFTaus = DQMEDAnalyzer('HLTTauDQMOfflineSource',
    ...
    PtHistoBins = cms.untracked.int32(20),
    PtHistoMax = cms.untracked.double(200),
...
hltTauOfflineMonitor_TagAndProbe = hltTauOfflineMonitor_PFTaus.clone(
    ...
    TagAndProbe = cms.untracked.VPSet(
       cms.untracked.PSet(
           ...
           numerator   = TriggerSelectionParameters(cms.vstring('HLT_IsoMu24_eta2p1_MediumDeepTauPFTauHPS35_L2NN_eta2p1_CrossL1_v1')),
           denominator = TriggerSelectionParameters(cms.vstring('HLT_IsoMu27_v16'))
       ),
        cms.untracked.PSet(
            name        = cms.string('MuTau30'),
            xvariable   = cms.string('Tau'),
            nPtBins     = cms.int32(20),
            ptmin       = cms.double(0.),
            ptmax       = cms.double(200.),
            ...
            phimin      = cms.double(-3.15),
            phimax      = cms.double(3.15),
            numerator   = TriggerSelectionParameters(cms.vstring('HLT_IsoMu24_eta2p1_MediumDeepTauPFTauHPS30_L2NN_eta2p1_CrossL1_v1')),
            denominator = TriggerSelectionParameters(cms.vstring('HLT_IsoMu27_v16'))
        ),
        cms.untracked.PSet(
            name        = cms.string('MuTau30Jet'),
            ...
            phimin      = cms.double(-3.15),
            phimax      = cms.double(3.15), 
            numerator   = TriggerSelectionParameters(cms.vstring('HLT_IsoMu24_eta2p1_MediumDeepTauPFTauHPS30_L2NN_eta2p1_PFJet60_CrossL1_v1')),
            denominator = TriggerSelectionParameters(cms.vstring('HLT_IsoMu24_eta2p1_MediumDeepTauPFTauHPS30_L2NN_eta2p1_CrossL1_v1'))
        ),
        # cms.untracked.PSet(
