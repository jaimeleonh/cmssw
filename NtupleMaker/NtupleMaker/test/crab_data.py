...
config.JobType.psetName = 'ProduceDeepTauL2TuplediTauJet_nooff.py'#'AODConfFile.py'#'zeroBiasHLT.py'#'HLTandRAW4520Taus.py'#'ditau_and_vbf.py'
...
config.JobType.inputFiles = ['L1Menu_Collisions2022_v0_1_1_modified_noVBF_Dec16.xml']

config.Data.inputDataset = '/EphemeralZeroBias/Run2018D-v1/RAW'
