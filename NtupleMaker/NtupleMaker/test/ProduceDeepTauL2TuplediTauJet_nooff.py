...
process.demo = cms.EDAnalyzer('NtupleMaker'
     ...
     , fillingL1 = cms.untracked.bool(False)    # False for data
     , fillingTaus = cms.untracked.bool(False)  # False for data
     , fillingJets = cms.untracked.bool(False)  # False for data
