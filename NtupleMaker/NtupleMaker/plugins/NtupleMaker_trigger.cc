...
int passhltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg;
int hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_nTaus;
vector<float> hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_pt;
vector<float> hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_eta;
vector<float> hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_phi;
vector<float> hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_energy;

int passHLT1PFJetFilter;
int HLT1PFJetFilter_nJets;
vector<float> HLT1PFJetFilter_pt;
vector<float> HLT1PFJetFilter_eta;
vector<float> HLT1PFJetFilter_phi;
vector<float> HLT1PFJetFilter_energy;
...
void NtupleMaker::branchesTriggers(TTree* tree){
    ...
    tree->Branch("hltL1DoubleTauJet_jetPt", &hltL1DoubleTauJet_jetPt);
    tree->Branch("hltL1DoubleTauJet_jetEta", &hltL1DoubleTauJet_jetEta);
    tree->Branch("hltL1DoubleTauJet_jetPhi", &hltL1DoubleTauJet_jetPhi);
    tree->Branch("hltL1DoubleTauJet_jetEnergy", &hltL1DoubleTauJet_jetEnergy);
    tree->Branch("hltL1DoubleTauJet_nTaus", &hltL1DoubleTauJet_nTaus);
    tree->Branch("hltL1DoubleTauJet_tauPt", &hltL1DoubleTauJet_tauPt);
    tree->Branch("hltL1DoubleTauJet_tauEta", &hltL1DoubleTauJet_tauEta);
    tree->Branch("hltL1DoubleTauJet_tauPhi", &hltL1DoubleTauJet_tauPhi);
    tree->Branch("hltL1DoubleTauJet_tauEnergy", &hltL1DoubleTauJet_tauEnergy);
    ...
    tree->Branch("passhltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg", &passhltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg);
    tree->Branch("hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_nTaus", &hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_nTaus);
    tree->Branch("hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_pt", &hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_pt);
    tree->Branch("hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_eta", &hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_eta);
    tree->Branch("hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_phi", &hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_phi);
    tree->Branch("hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_energy", &hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_energy);
    
    tree->Branch("passHLT1PFJetFilter", &passHLT1PFJetFilter);
    tree->Branch("HLT1PFJetFilter_nJets", &HLT1PFJetFilter_nJets);
    tree->Branch("HLT1PFJetFilter_eta", &HLT1PFJetFilter_eta);
    tree->Branch("HLT1PFJetFilter_phi", &HLT1PFJetFilter_phi);
    tree->Branch("HLT1PFJetFilter_phi", &HLT1PFJetFilter_phi);
    tree->Branch("HLT1PFJetFilter_energy", &HLT1PFJetFilter_energy);
...
void NtupleMaker::fillTriggers(const edm::Event& iEvent){
    ...
    passhltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg = 0;
    hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_nTaus = 0;
    hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_pt.clear();
    hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_eta.clear();
    hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_phi.clear();
    hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_energy.clear();
    
    passHLT1PFJetFilter = 0;
    HLT1PFJetFilter_nJets = 0;
    HLT1PFJetFilter_pt.clear();
    HLT1PFJetFilter_eta.clear();
    HLT1PFJetFilter_phi.clear();
    HLT1PFJetFilter_energy.clear();
    ...
    // 2 Tau + Jet
    std::string pathNameDoubleTauJet = "HLT_DoubleMediumChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_PFJet60";
    ...
    const unsigned int filterIndex(triggerEventWithRefsHandle_->filterIndex(InputTag("hltL1DoubleTauJet", "", "MYHLT")));
    ...
    const unsigned int filterIndex35(triggerEventWithRefsHandle_->filterIndex(InputTag("hltL1DoubleTau35", "", "MYHLT")));
    //making tau object and filling vector
    ...
    std::string hltL1DoubleTauJet_Tag = "hltL1DoubleTauJet::MYHLT";	  // proposed L1
    std::string hltL1DoubleTau32_Tag = "hltL1sDoubleTauBigOR::MYHLT";	  // ditau32 L1
    std::string hltL1DoubleTau35_Tag = "hltL1DoubleTau35::MYHLT";	  // ditau35 L1
    ...
    std::string hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_Tag = "hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg::MYHLT";
    ...
    for(trigger::size_type iFilter=0; iFilter!=nFilters; ++iFilter) {
        ...
        // DoubleIsoTauJet Final Filters
        if (filterTag == hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_Tag && nObjKeys >= 2) passhltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg = 1;
        if (filterTag == HLT1PFJetFilter_Tag && nObjKeys >= 1) passHLT1PFJetFilter = 1;
        ...
        for(trigger::size_type iKey=0; iKey < nObjKeys; ++iKey){
            ...
            // }
            if (filterTag == hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_Tag
                    && passhltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg && pt_>0) {
                hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_pt.push_back(pt_);
                hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_eta.push_back(eta_);
                hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_phi.push_back(phi_);
                hltHpsDoublePFTau30TrackPt1MediumChargedIsolationAndTightOOSCPhotonsDz02Reg_energy.push_back(energy_);
            }
            else if (filterTag == HLT1PFJetFilter_Tag && passHLT1PFJetFilter && pt_>0) {
                HLT1PFJetFilter_pt.push_back(pt_);
                HLT1PFJetFilter_eta.push_back(eta_);
                HLT1PFJetFilter_phi.push_back(phi_);
                HLT1PFJetFilter_energy.push_back(energy_);
            }
