...
namespace ALPAKA_ACCELERATOR_NAMESPACE::l1sc {
  ...
  class L1TScPhase2VertexRawToDigi : public stream::EDProducer<> {
  public:
  ...
  private:
    ...
    // kernel
    kernels::L1TScPhase2VertexRawToDigiKernels rtd_kernels_;
  };

}  // namespace ALPAKA_ACCELERATOR_NAMESPACE::l1sc

DEFINE_FWK_ALPAKA_MODULE(l1sc::L1TScPhase2VertexRawToDigi);