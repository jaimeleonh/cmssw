#ifndef PhysicsTools_ParticleTransformerAlpakaFP32_ModelConstants_h
#define PhysicsTools_ParticleTransformerAlpakaFP32_ModelConstants_h
...
namespace partfp32 {
  ...
  inline constexpr int kNormScratch = kFfnTokenTile * kEmbedDim;  // 1024
