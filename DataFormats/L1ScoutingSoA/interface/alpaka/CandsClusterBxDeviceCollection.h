...
namespace ALPAKA_ACCELERATOR_NAMESPACE::l1sc {
  ...
  using CandsClusterBxDeviceCollection = PortableCollection4<IndexSoA, ClusterOffsetsSoA, BxIndexSoA, OffsetSoA>;

}  // namespace ALPAKA_ACCELERATOR_NAMESPACE::l1sc

ASSERT_DEVICE_MATCHES_HOST_COLLECTION(l1sc::CandsClusterBxDeviceCollection, l1sc::CandsClusterHostCollection);
