#ifndef DataFormats_L1ScoutingSoA_interface_alpaka_LongAssociationMapDevice_h
#define DataFormats_L1ScoutingSoA_interface_alpaka_LongAssociationMapDevice_h
...
namespace ALPAKA_ACCELERATOR_NAMESPACE::l1sc {
  ...
  using LongAssociationMapDevice = PortableCollection2<LongIndexSoA, LongOffsetsSoA>;

}  // namespace ALPAKA_ACCELERATOR_NAMESPACE::l1sc

ASSERT_DEVICE_MATCHES_HOST_COLLECTION(l1sc::LongAssociationMapDevice, l1sc::LongAssociationMapHost);
